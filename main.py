...
label_surname_szczegoly_obiektow = Label(ramka_szczegoly_obiektow, text="Miejscowość")
label_surname_szczegoly_obiektow.grid(row=1, column=4)
label_surname_szczegoly_obiektow = Label(ramka_szczegoly_obiektow, text="......")
label_surname_szczegoly_obiektow.grid(row=1, column=5)
label_surname_szczegoly_obiektow = Label(ramka_szczegoly_obiektow, text="Posty")
label_surname_szczegoly_obiektow.grid(row=1, column=6)
label_surname_szczegoly_obiektow = Label(ramka_szczegoly_obiektow, text="......")
label_surname_szczegoly_obiektow.grid(row=1, column=7)
